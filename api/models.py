...
class User(Base):
    ...
    mfa_passkey_public_key = Column(Text, nullable=True)
    mfa_passkey_sign_count = Column(Integer, default=0)
    mfa_passkey_device_type = Column(String, nullable=True)
    mfa_passkey_backed_up = Column(Boolean, default=False)
