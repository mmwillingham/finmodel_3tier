...
def create_authorized_user(
    ...
    try:
        ...
        login_link = f"{settings.FRONTEND_URL or 'https://www.modelmyretirement.com'}/login"
...
You will be required to change your password on first login for security."""
            ...
            signup_link = f"{settings.FRONTEND_URL or 'https://www.modelmyretirement.com'}/signup"
