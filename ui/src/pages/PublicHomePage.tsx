...
const buildSampleImage = ({ title, accent }: any) => {
...
const PublicHomePage = () => {
  ...
  useEffect(() => {
    const urls = samples.map((sample: any) => sample.url || buildSampleImage(sample));
    setImages(urls);
  }, [samples]);
    ...
    <div className="public-home">
      ...
      {expandedImage && (
        <div className="public-lightbox" onClick={() => setExpandedImage(null)}>
          <div className="public-lightbox-content" onClick={(event: any) => event.stopPropagation()}>
