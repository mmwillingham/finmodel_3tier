...
const AutoDisbursementSettingsPage = () => {
  ...
  const [autoDisbursements, setAutoDisbursements] = useState<any[]>([]);
  ...
  const [rmdSchedule, setRmdSchedule] = useState<any>(null);
  ...
  const loadData = useCallback(async () => {
    ...
    const [autoDisbursementsData, assetsRes, accountsRes, settingsRes] = await Promise.all([
        AutoDisbursementService.getAllAutoDisbursements(viewingUserId).catch((err: any) => {
          return [] as any[];
        }),
        AssetService.list(viewingUserId || null).catch((err: any) => {
          return { data: [] as any[] };
        }),
        // Load accounts to determine retirement flags for filtering
      AccountService.getAllAccounts(viewingUserId).catch((err: any) => {
          return [] as any[];
        }),
        SettingsService.getSettings(viewingUserId).catch((err: any) => {
          return { data: {} };
        }),
      ]);
  ...
  // RMD states
  const [recommendedRmd, setRecommendedRmd] = useState<any>(null);
  ...
  const transferValueRef = useRef<any>(null);
  ...
  const getRmdStartYear = (birthdateStr: any) => {
  ...
  useEffect(() => {
    ...
    if (startYear) {
      setNewAutoDisbursement((prev: any) => ({ ...prev, start_date: `${startYear}-01-01` }));
    }
  ...
  useEffect(() => {
    ...
    setNewAutoDisbursement((prev: any) => ({ ...prev, transfer_type: 'dollar_amount', transfer_value: roundedValue }));
  ...
  const handleCreateAutoDisbursement = async () => {
    ...
    if (newAutoDisbursement.distribution_type === 'taxable_ira') {
      ...
      const sourceAsset = assets.find((a: any) => a.id === parseInt(newAutoDisbursement.source_asset_id));
      const sourceAccount = accounts.find((acc: any) => acc.id === (sourceAsset?.account_id || null));
      ...
      const targetAsset = assets.find((a: any) => a.id === parseInt(newAutoDisbursement.target_asset_id));
      const targetAccount = accounts.find((acc: any) => acc.id === (targetAsset?.account_id || null));
    ...
    if (!newAutoDisbursement.use_rmd || !useRecommendedRmdValue) {
      ...
      const recommendedValue = Number(recommendedRmd?.rmd_amount ?? 0);
  ...
  const handleUpdateAutoDisbursement = async (id: any, updatedAutoDisbursement: any) => {
    if (isViewingOther) {
      setMessage('Automatic transfers are read-only when viewing another account.');
      setTimeout(() => setMessage(''), 3000);
      return;
  ...
  const handleDeleteAutoDisbursement = async (id: any) => {
    if (isViewingOther) {
      setMessage('Automatic transfers are read-only when viewing another account.');
      setTimeout(() => setMessage(''), 3000);
      return;
            ...
            <>
              ...
              <div className="form-field">
                ...
                <input
                  ...
                  onChange={(e: any) => {
                    ...
                    setRmdError('');
                    setNewAutoDisbursement((prev: any) => ({ ...prev, name: val }));
                  }}
                  className="input-modern"
                />
              </div>
              <div className="form-field">
                ...
                <select
                  ...
                  onChange={(e: any) => setNewAutoDisbursement((prev: any) => ({ ...prev, distribution_type: e.target.value || 'non_taxable' }))}
                  className="input-modern"
                >
                    ...
                    <label style={{ display: 'block', marginTop: '8px' }}>
                      <input
                        ...
                        onChange={(e: any) => {
                          ...
                          setNewAutoDisbursement((prev: any) => {
              ...
              <div className="form-field">
                ...
                <select
                  ...
                  onChange={(e: any) => setNewAutoDisbursement((prev: any) => ({ ...prev, transfer_type: e.target.value }))}
                  className="input-modern"
                >
              ...
              <div className="form-field">
                ...
                <select
                  ...
                  onChange={(e: any) => setNewAutoDisbursement((prev: any) => ({ ...prev, source_asset_id: e.target.value || '' }))}
                  className="input-modern"
              ...
              <div className="form-field">
                ...
                <select
                  ...
                  onChange={(e: any) => setNewAutoDisbursement((prev: any) => ({ ...prev, target_asset_id: e.target.value || '' }))}
                  className="input-modern"
                  style={{ width: '100%', minWidth: 0 }}
                >
              ...
              <div className="form-field">
                ...
                <input
                  ...
                  onChange={(e: any) => {
                    const val = e.target.value;
                    setRmdError('');
                    setNewAutoDisbursement((prev: any) => ({ ...prev, transfer_value: val }));
                  }}
                  ...
                  <div style={{ marginTop: '8px' }}>
                    <label style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <input
                        ...
                        onChange={(e: any) => setUseRecommendedRmdValue(e.target.checked)}
                      />
                      Use recommended RMD
                    </label>
                    <small style={{ display: 'block', color: '#666', marginTop: '6px' }}>
              ...
              <div className="form-field">
                ...
                <input
                  ...
                  onChange={(e: any) => {
                    const val = e.target.value;
                    setRmdError('');
                    setNewAutoDisbursement((prev: any) => ({ ...prev, start_date: val }));
                  }}
                  className="input-modern"
                />
              ...
              <div className="form-field">
                ...
                <input
                  ...
                  onChange={(e: any) => {
                    const val = e.target.value;
                    setRmdError('');
                    setNewAutoDisbursement((prev: any) => ({ ...prev, end_date: val }));
                  }}
                  className="input-modern"
                />
                <small style={{ color: '#666', fontSize: '0.8em', marginTop: '3px', display: 'block' }}>Optional</small>
                    ...
                    <>
                      ...
                      <td>
                        <select
                          ...
                          onChange={(e: any) => setEditingAutoDisbursement({ ...editingAutoDisbursement, source_asset_id: e.target.value ? parseInt(e.target.value) : null })}
                          style={{ width: '100%', padding: '5px' }}
                        >
                          <option value="">Select Source Asset</option>
                          {assets.map((asset: any) => (
                      ...
                      <td>
                        <select
                          ...
                          onChange={(e: any) => setEditingAutoDisbursement({ ...editingAutoDisbursement, target_asset_id: e.target.value ? parseInt(e.target.value) : null })}
                          style={{ width: '100%', padding: '5px' }}
                        >
                          <option value="">Select Target Asset</option>
                          {assets.map((asset: any) => (
                      ...
                      <td>
                        <select
                          ...
                          onChange={(e: any) => setEditingAutoDisbursement({ ...editingAutoDisbursement, transfer_type: e.target.value })}
                          style={{ width: '100%', padding: '5px' }}
                        >
                          <option value="percentage">Percentage</option>
                          <option value="dollar_amount">Dollar Amount</option>
                      ...
                      <td>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                          ...
                          value={editingAutoDisbursement.transfer_value ?? ''}
                            onChange={(e: any) => setEditingAutoDisbursement({ ...editingAutoDisbursement, transfer_value: e.target.value })}
                            style={{ width: '100%', padding: '5px' }}
                          />
