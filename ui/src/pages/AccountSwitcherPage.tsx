...
const AccountSwitcherPage = () => {
    ...
    const handleAccountChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        if (selectedId === currentUser?.id) {
            ...
            const selectedAccount = accessibleAccounts.find((acc: any) => acc.id === selectedId);
    ...
    const currentAccount = accessibleAccounts.find((acc: any) => acc.id === currentViewingId) || accessibleAccounts.find((acc: any) => acc.id === currentUser?.id) || accessibleAccounts[0];
