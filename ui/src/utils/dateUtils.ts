 ...
 */
export function calculateYearFraction(startDate: any, endDate: any, projectionYear: any) {
  ...
  const overlapDays = Math.floor((overlapEnd.getTime() - overlapStart.getTime()) / millisecondsPerDay) + 1;
