...
export function calculateFRA(birthYear: any) {
  /**
...
export function calculateFRADate(birthDate: any) {
  /**
...
export function formatFRADisplay(birthDate: any) {
  /**
...
export function calculateMonthlyBenefit(pia: any, retirementDate: any, fraDate: any, birthDate: any) {
  /**
...
export function getMinRetirementDate(birthDate: any) {
  /**
