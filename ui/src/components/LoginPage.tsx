                                ...
                                <button
                                    ...
                                    onClick={async () => {
                                        ...
                                        try {
                                            ...
                                            const verifyResponse = await AuthService.verifyPasskeyAuthentication(mfaToken, credential as any, rememberDevice);
                                            await login();
                        ...
                        <div className="form-group">
                            <label htmlFor="mfa-remember" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                <input
                                    ...
                                    onChange={(e: any) => setRememberDevice(e.target.checked)}
                                    disabled={otpLoading}
                                />
