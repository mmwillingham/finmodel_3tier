...
const AssetsSetupWizard = ({ isOpen, onClose, onComplete }) => {
                  ...
                  <div className="wizard-form">
                    ...
                    <div className="form-group">
                      ...
                      <select
                        ...
                        onChange={(e) => setNewAsset({ ...newAsset, account_id: e.target.value ? parseInt(e.target.value) : null })}
                      >
                    ...
                    <div className="form-group">
                      ...
                      <select
                        ...
                        onChange={(e) => setNewAsset({ ...newAsset, annual_change_type: e.target.value })}
                      >
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setNewAsset({ ...newAsset, annual_increase_percent: e.target.value })}
                        placeholder="0.0"
                      />
                    </div>
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setNewAsset({ ...newAsset, start_date: e.target.value })}
                      />
                    </div>
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setNewAsset({ ...newAsset, end_date: e.target.value })}
                      />
                    </div>
                    <button 
