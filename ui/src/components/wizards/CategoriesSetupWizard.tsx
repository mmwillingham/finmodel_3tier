...
import './Wizard.css';
  ...
  const CategoriesSetupWizard = ({ isOpen, onClose, onComplete }: any) => {
  const [currentStep, setCurrentStep] = useState(1);
  const [loading, setLoading] = useState(false);
  const [message, setMessage] = useState('');
  
  const [assetCategories, setAssetCategories] = useState<any[]>([]);
  const [liabilityCategories, setLiabilityCategories] = useState<any[]>([]);
                ...
                <div className="category-display">
                  {assetCategories.length > 0 ? (
                    <div className="category-tags">
                      {assetCategories.map((cat: any, idx: any) => (
              ...
              <div className="wizard-category-section">
                <div className="category-display">
                  {liabilityCategories.length > 0 ? (
                    <div className="category-tags">
                      {liabilityCategories.map((cat: any, idx: any) => (
                        <span key={idx} className="category-tag">{cat}</span>
                      ))}
                    </div>
                  ) : (
              ...
              <div className="wizard-category-section">
                <div className="category-display">
                  {incomeCategories.length > 0 ? (
                    <div className="category-tags">
                      {incomeCategories.map((cat: any, idx: any) => (
                        <span key={idx} className="category-tag">{cat}</span>
                      ))}
                    </div>
                  ) : (
              ...
              <div className="wizard-category-section">
                <div className="category-display">
                  {expenseCategories.length > 0 ? (
                    <div className="category-tags">
                      {expenseCategories.map((cat: any, idx: any) => (
                        <span key={idx} className="category-tag">{cat}</span>
                      ))}
                    </div>
                  ) : (
