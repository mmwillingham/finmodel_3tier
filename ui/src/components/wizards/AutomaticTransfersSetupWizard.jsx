  ...
  const loadData = async () => {
    try {
      const [assetsRes, transfersRes, settingsRes] = await Promise.all([
        AssetService.list(),
        AutoDisbursementService.getAllAutoDisbursements().catch(() => []),
                  ...
                  <div className="wizard-form">
                    ...
                    <div className="form-group">
                      ...
                      <select
                        ...
                        onChange={(e) => setNewTransfer({ ...newTransfer, source_asset_id: e.target.value ? parseInt(e.target.value) : null })}
                      >
                    ...
                    <div className="form-group">
                      ...
                      <select
                        ...
                        onChange={(e) => setNewTransfer({ ...newTransfer, target_asset_id: e.target.value ? parseInt(e.target.value) : null })}
                      >
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setNewTransfer({ ...newTransfer, start_date: e.target.value })}
                      />
                    </div>
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setNewTransfer({ ...newTransfer, end_date: e.target.value })}
                      />
                    </div>
                    <button 
                      className="wizard-btn wizard-btn-primary" 
