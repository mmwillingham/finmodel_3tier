...
const HelpModal: React.FC<HelpModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="help-modal-overlay" onClick={onClose}>
      <div className="help-modal-content" onClick={(e: any) => e.stopPropagation()}>
        ...
        <div className="help-modal-body">
          ...
          <div className="help-content-display">
            {loading ? (
              ...
              <textarea
                value={helpContent}
                onChange={(e: any) => setHelpContent(e.target.value)}
                rows={20}
              ...
              <div 
                ...
                onClick={(e: React.MouseEvent<HTMLDivElement>) => {
                  ...
                  if (target) {
                    ...
                    const modalContent = document.querySelector('.help-modal-content') as HTMLElement | null;
                    ...
                    if (href === '#top') {
                      ...
                      setTimeout(() => {
                        ...
                        if (targetElement) {
                          const headerHeight = (document.querySelector('.help-modal-header') as HTMLElement | null)?.offsetHeight || 0;
