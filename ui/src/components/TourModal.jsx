...
const TourModal = ({ isOpen, onClose, onRequestSettingsMenu, stepIndex, onStepIndexChange }) => {
  ...
  const updateTargets = useCallback(() => {
    ...
    const elements = step.targetIds
      .map((targetId) => document.querySelector(`[data-tour-id="${targetId}"]`))
      .filter(Boolean);
  ...
  useEffect(() => {
    ...
    const needsSettingsMenu = step?.targetIds?.some((targetId) =>
